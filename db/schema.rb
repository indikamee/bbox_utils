...
ActiveRecord::Schema.define(version: 2023_11_29_030131) do
  ...
  create_table "tickets", force: :cascade do |t|
    ...
    t.index ["event_id", "ticket_type", "seq"], name: "index_tickets_on_event_id_and_ticket_type_and_seq", unique: true
